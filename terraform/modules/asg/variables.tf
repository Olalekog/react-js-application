...
variable "app_environment_variables" { type = map(string) default = {} }
...
variable "root_device_name" { type = string default = "/dev/xvda" }
variable "ami_name_filter" { type = string default = "al2023-ami-*-x86_64" }
